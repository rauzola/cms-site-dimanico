        ...
        <div className={`relative w-full md:w-auto ${isMenuOpen ? 'block' : 'hidden'} md:block`} id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li className="relative">
              ...
              {/* Dropdown menu */}
              <div className={`absolute left-0 mt-2 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow z-20 ${isDropdownOpen ? 'block' : 'hidden'} dark:bg-gray-700 dark:divide-gray-600`}>
